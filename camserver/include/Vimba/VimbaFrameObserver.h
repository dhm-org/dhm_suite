 ...
 ******************************************************************************
  ...
  @Modified			 F. Loya
  @par Description:  Frame Observer Class for Vimba SDK; Captures frames from the camera driver.
 ******************************************************************************
 */
#ifndef _VIMBA_FRAME_OBSERVER_H_
#define _VIMBA_FRAME_OBSERVER_H_
...
public:
    ...
    VimbaFrameObserver(AVT::VmbAPI::CameraPtr pCamera, CircularBuffer *circbuf, bool logging_enabled ,int maxWidth, int maxHeight, char *rootdir, char* datadir, char* sessiondir, bool verbose);
    ~VimbaFrameObserver();
